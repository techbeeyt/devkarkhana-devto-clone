...
const Notifications = () => {
  return (
    <div className='w-full min-h-screen'>
      <div className='w-full lg:w-3/4 mx-auto h-80'>
        <div className='w-full flex justify-between items-center p-2 pt-4 lg:my-4'>
          <h1 className='text-black text-3xl font-bold'>Notifications</h1>
        ...
        <div className='w-full flex flex-col sm:flex-row'>
          <div className='w-full sm:w-1/3'>
            <div className="drawer-side">
              ...
              <ul className="menu py-2 px-4 sm:px-0 overflow-y-auto w-full bg-base-100 text-base-content flex flex-row justify-between sm:flex-col ">
